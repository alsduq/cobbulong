...
<html>
<head>
<link rel="stylesheet" type="text/css" href="<c:url value='/css/bootstrap-grid.css'/>">
<link rel="stylesheet" type="text/css" href="<c:url value='/css/bootstrap-reboot.css'/>">
