...
//	@Autowired
//	private LogoutUtils logoutUtils;
...
//	private MemberDAO memberDAO;
    ...
    public void valueBound(HttpSessionBindingEvent event) {
     ...
     public void valueUnbound(HttpSessionBindingEvent event) {
    	 WebApplicationContext context = WebApplicationContextUtils.getWebApplicationContext(event.getSession().getServletContext(), FrameworkServlet.SERVLET_CONTEXT_PREFIX + "action");
    	 ...
    	 map.put("inputId", event.getName());
    	 memberDAO.updateLogOutLog(map);
//         logoutUtils.logoutLog(event.getName());
     }
